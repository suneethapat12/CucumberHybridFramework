...
public class Login {
	...
	@When("^User enters valid email address (.+) into emailfield$")
	public void user_enters_valid_email_address_into_emailfield(String emailText) {
	...
	public void user_enters_invalid_email_address_into_emailfield() {
	...
	public void user_dont_enter_emailaddress_into_email_field() {
